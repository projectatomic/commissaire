# This code was copied from Marc Abramowitz's requests-unixsocket module
# <https://github.com/msabramo/requests-unixsocket> under the Apache 2.0
# license, which is compatible with GPLv3.
#
